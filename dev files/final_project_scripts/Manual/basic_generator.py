...
# Define the variables representing the different attributes for a driving scenario
...
class ScenarioGenerator:
    ...
    def generate_scenarios(self):
        ...
        # Check if the file exists and create an empty JSON file if it doesn't
        if not os.path.exists('step1/random_scenarios.json'):
        ...
        # Find the highest numbered route file in the directory
        ...
        # Generate the desired number of scenarios
        for i in range(highest_number, self.num_scenarios):
            ...
            # Connect to the Carla server and load the world based on the location choice
            ...
            # Generate waypoints for the world and create a function to calculate route length
            map = world.get_map()
            ...
            for start_waypoint in waypoints:
                for end_waypoint in waypoints:
                    ...
                    if (found_route_length > (route_length_choice - (route_length_choice * 0.2))
                        ...
                        # Calculate the total difficulty rating for the generated scenario
                        ...
                        # Create the scenario dictionary and save it to the JSON file
                        scenario = {
                            'scenario_num': i,
                        ...
                        # Save the route coordinates to a separate JSON file
...
#Set the desired number of scenarios to generate
num_scenarios = 80
