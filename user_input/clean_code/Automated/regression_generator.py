                ...
                for end_waypoint in waypoints:
                    ...
                    if (found_route_length > (route_length_choice - (route_length_choice * 0.2))
                        ...
                        if  y_pred_unrated[0] < difficulty_threshold:
                            ...
                            with open('step5/filtered_scenarios.json', 'w') as f:
                            ...
                            with open(f'step5/filtered_route_{counter}.json', 'w') as f:
...
if not os.path.exists('step5/filtered_scenarios.json'):
    with open('step5/filtered_scenarios.json', 'w') as f:
        json.dump([], f)
...
# scenario_generator.generate_scenarios_with_threshold(filtered_data,50)
