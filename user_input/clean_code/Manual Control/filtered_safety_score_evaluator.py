...
with open("step5/filtered_scenarios.json", "r") as file:
        scenario_data = json.load(file)

rated_objects = []
count = 0
for root, dirs, files in os.walk('step6'):
    for file in files:
        if 'auto_scenario' in file:
            ...
            with open(f'step5/filtered_route_{scenario_num}.json', 'r') as f:
                trajectory = json.load(f)

            with open(f'step6/auto_scenario_{scenario_num}.json') as f:
            ...
            with open('step5/filtered_scenarios.json', 'r') as f:
                data = json.load(f)
...
with open('step7/rated_filtered_scenarios.json', 'w') as f:
