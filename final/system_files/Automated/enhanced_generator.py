...
# Generate scenarios with a predicted safety score of 25 or less
# change the threshold according to your needs, to generate scenarios with different safety scores
